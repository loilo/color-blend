import { RGB, RGBA, NoAlphaBlender, ChannelBlender } from './types'
 ...
 * @return The { r,g,b,a } with rounded color channels
 */
function roundChannelsForSanity (color: RGBA): RGBA {
 ...
 */
function alphaCompose (backdropAlpha: number, sourceAlpha: number, compositeAlpha: number, backdropColor: number, sourceColor: number, compositeColor: number) {
 ...
 * @param {function} abstractModeCallback  The abstract blend mode function (separable vs. non-separable)
 * @param {function} concreteModeCallback  The concrete blend mode function (normal, multiply, ...)
 * @param {object} options                 The options to apply
 * @return {object}                        The { r,g,b,a } result object, channel values are not rounded
 */
export function performBlend (backdrop: RGBA, source: RGBA, abstractModeCallback: (backdrop: RGBA, source: RGBA, concreteModeCallback: ChannelBlender) => RGB, concreteModeCallback: ChannelBlender, options?: Partial<BlendOptions>): RGBA
export function performBlend (backdrop: RGBA, source: RGBA, abstractModeCallback: (backdrop: RGBA, source: RGBA, concreteModeCallback: NoAlphaBlender) => RGB, concreteModeCallback: NoAlphaBlender, options?: Partial<BlendOptions>): RGBA
export function performBlend (backdrop: RGBA, source: RGBA, abstractModeCallback: (backdrop: RGBA, source: RGBA, concreteModeCallback: any) => RGB, concreteModeCallback: ChannelBlender | NoAlphaBlender, options: Partial<BlendOptions> = {
  unitInput: false,
  unitOutput: false,
  roundOutput: true
}) {
  ...
  // Round anyways to get rid of JavaScript floating point issues
    ...
    resultRGBA = roundChannelsForSanity(resultRGBA)
  }
